...
public class ColoredCubeMazeFromImage : MonoBehaviour
{
	...
	void Start ()
	{
        ...
        Texture2D mazeImage = Resources.Load("Images/Sand512 ") as Texture2D;
        ...
        //TerrainVolumeData data = VolumeData.CreateEmptyVolumeData<SimpleTerrainVolume>(new Region(0, 0, 0, width - 1, height - 1, depth - 1));
